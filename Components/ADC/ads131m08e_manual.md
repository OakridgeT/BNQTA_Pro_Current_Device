...
**Equation 2**
$$
Effective Resolution = {log}_{2} ((2\times {V}_{REF})\div (Gain\times {V}_{RMS}))
$$
...
**Equation 4**
$$
330 k\Omega \times 4.096 MHz\div {f}_{MOD}
$$
...
**Equation 6**
$$
{\left| {H(z)} \right|} = {{\left| {(1 - {z}^{N})\div (N(1-{z}^{-1}))} \right|}}^{3} 
$$
...
**Equation 7**
$$
H(f) = {{\left| {\sin ((N \times \pi \times f)/({f}_{MOD})) / (N \times \sin ((\pi \times f)/{f}_{MOD}))} \right|}}^{3}
$$
...
**Equation 8**
$$
t_{GC\_CONVERSION} = t_{GC\_DLY} + 3 \times OSR + t_{MOD}
$$


**Equation 9**
$$
t_{GC\_FIRST\_CONVERSION} = t_{GC\_DLY} + 3 \times OSR \times t_{MOD} + t_{GC\_DLY} + 3 \times OSR \times t_{MOD} + 44 \times t_{MOD}
$$
...
**Equation 11**
$$
VADC = \pm VRMS \times \sqrt{2}\times \frac{RLO}{3\times RHI + RLO}
$$
...
**Equation 12**
$$
VADC = \pm IRMS \times 2 \times RB \times \sqrt{2} \div NCT
$$
...
**Equation 13**
$$
Gain Error = \frac {V,I_{Max,Measured} - V,I_{Min,Measured}}{V,I_{Max} - V,I_{Min}}
$$
...
**Equation 14**
$$
PACTUAL.ph = \frac {1}{Nsamples} \times  \sum_{n=0}^{N_{samples}-1} {v{\left[ {n} \right]}\times i{\left[ {n} \right]}} 
$$

**Equation 15**
$$
PREACTIVE.ph = \frac {1}{Nsamples} \times  \sum_{n=0}^{N_{samples}-1} {v{\left[{n - n_{90°}} \right]}\times i{\left[ {n} \right]}}
$$

**Equation 16**
$$
{PAPPARENT.ph}^{2} = {PACTUAL.ph}^{2} + {PREACTIVE.ph}^{2}
$$
...
**Equation 17**
$$
Frequency(Hz) = Date rate(samples/seconds) \div Frequency(samples/cycle) 
$$
